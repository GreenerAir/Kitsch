...
class SportswearActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_sportswear)
    ...
    private fun loadWardrobeItems() {
        ...
        FirebaseFirestore.getInstance()
            ...
            .collection("Wardrobe")
            .whereEqualTo("category", "Sportswear")
            .get()
            .addOnSuccessListener { documents ->
                processFirestoreDocuments(documents)
            }
            .addOnFailureListener { e ->
                Log.e("SportswearActivity", "Error loading posts", e)
            }
    }
    ...
    private fun processFirestoreDocuments(documents: QuerySnapshot) {
        try {
            ...
            Log.e("SportswearActivity", "Error processing documents", e)
        }
    }
        ...
        db.collection("Users")
            ...
            .addOnSuccessListener {
                db.collection("Users")
                    ...
                    .addOnFailureListener { e ->
                        Log.e("SportswearActivity", "Failed to update count", e)
                        showToast("Item deleted but count not updated")
                    }
            }
            .addOnFailureListener { e ->
                Log.e("SportswearActivity", "Error deleting item", e)
