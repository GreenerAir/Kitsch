...
class TopsActivity : AppCompatActivity() {
    ...
    private fun initializeViews() {
        recyclerView = findViewById(R.id.topsRecyclerView)
    ...
    private fun loadWardrobeItems() {
        ...
        FirebaseFirestore.getInstance()
            ...
            .collection("Wardrobe")
            .whereEqualTo("category", "Tops")
            .get()
            .addOnSuccessListener { documents ->
                processFirestoreDocuments(documents)
            }
            .addOnFailureListener { e ->
                Log.e("BottomsActivity", "Error loading posts", e)
            }
    }
    ...
    private fun processFirestoreDocuments(documents: QuerySnapshot) {
        try {
            ...
            Log.e("BottomsActivity", "Error processing documents", e)
        }
    }
        ...
        db.collection("Users")
            ...
            .addOnSuccessListener {
                db.collection("Users")
                    ...
                    .addOnFailureListener { e ->
                        Log.e("BottomsActivity", "Failed to update count", e)
                        showToast("Item deleted but count not updated")
                    }
            }
            .addOnFailureListener { e ->
                Log.e("BottomsActivity", "Error deleting item", e)
